  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8 pt-10 pb-20">
    <div class="mx-auto max-w-2xl text-gray-900">
      ...
      <p class="mt-6 text-lg leading-8">
        It doesn&rsquo;t have to be this way. Let&rsquo;s help your employees,
        organization, or group
        <span class="font-semibold">thrive with money</span>.
      </p>
    </div>
    ...
    <div class="mx-auto max-w-2xl text-gray-900">
      ...
      <p class="mt-6 text-lg leading-8">
        The more financially savvy are also more likely to undertake retirement
        planning, and
