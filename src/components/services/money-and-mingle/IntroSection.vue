      ...
      <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
        <div class="sm:max-w-lg text-gray-900">
          ...
          <p class="mt-6 text-lg">
            Talking about money can often be boring. Or it can make you feel
            fearful, anxious, or envious.
          </p>
          <p class="mt-6 text-lg">
            What if we flipped the script? What if there were a
            <strong class="font-semibold">safe space</strong> where you could
            talk about money and
            <strong class="font-semibold"
              >be inspired, feel connected, and gain clarity</strong
            >
          ...
          <p class="mt-6">
            This is money talk that
            <strong class="font-semibold"
              >transforms the way you think about money</strong
            >.
          </p>
        </div>
        <div class="mt-16">
