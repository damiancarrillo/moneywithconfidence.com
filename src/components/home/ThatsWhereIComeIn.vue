...
<template>
  <div class="pb-10 overflow-hidden bg-white">
    <div class="px-6 mx-auto max-w-7xl lg:flex lg:px-8">
      ...
      >
        <div class="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
          <div class="pb-12">
            <img
              ...
              class="aspect-[7/5] rounded-2xl bg-gray-50 object-cover shadow-xl lg:hidden"
            />
          </div>
          <h2
            class="text-4xl font-bold tracking-tight text-gray-900 font-header sm:text-4xl"
          >
        ...
        <div
          class="flex-wrap items-start justify-end hidden gap-6 sm:gap-8 lg:contents"
        >
          <div
          ...
          >
            <div
              class="flex self-end justify-end flex-none order-first w-64 lg:w-auto"
            >
              <img
